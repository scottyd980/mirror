defmodule Mirror.UserControllerTest do
  use Mirror.ConnCase
  ...
  test "returns currently authenticated user if a user is logged in", %{conn: conn, user: user} do
  ...
  test "returns a user for the given user id", %{conn: conn, user: user} do
