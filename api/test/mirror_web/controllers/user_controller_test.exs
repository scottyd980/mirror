defmodule MirrorWeb.UserControllerTest do
  use MirrorWeb.ConnCase

  alias Mirror.Accounts
  alias Mirror.Accounts.User

  @create_attrs %{email: "some email", password: "some password", password_confirmation: "some password_confirmation", password_hash: "some password_hash", username: "some username"}
