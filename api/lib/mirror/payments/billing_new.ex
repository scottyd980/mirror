defmodule Mirror.Payments.BillingNew do
  ...
  def process_subscription(organization, frequency_updated \\ false) do
    ...
    Logger.error "#{inspect existing_subs}"
    ...
    # TODO: Need to handle billing frequency change
    case organization_status do
      ...
      :existing ->
        ...
        cond do
          num_teams == 0 -> {:ok, :continue} #TODO: Handle this
